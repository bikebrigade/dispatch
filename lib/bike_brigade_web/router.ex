defmodule BikeBrigadeWeb.Router do
  ...
  scope "/", BikeBrigadeWeb do
    ...
    live_session :dispatch, on_mount: {LiveHooks.Authentication, :require_dispatcher} do
      ...
      live "/campaigns/:id/messaging/riders/", CampaignLive.Show, :campaign_messaging_index
      live "/campaigns/:id/messaging/riders/:rider_id", CampaignLive.Show, :campaign_messaging_show
...
defmodule BikeBrigadeWeb.Plugs.RedirectUser do
  alias BikeBrigadeWeb.Plugs.Redirect
